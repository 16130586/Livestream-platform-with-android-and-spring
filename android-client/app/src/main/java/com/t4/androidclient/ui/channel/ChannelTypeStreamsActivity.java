...
public class ChannelTypeStreamsActivity extends AppCompatActivity implements MakeSuggestion {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Click back về Home
        app_logo = findViewById(R.id.back_to_types_logo);
        app_logo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
                overridePendingTransition(0, 0);
                Intent backHome = new Intent(ChannelTypeStreamsActivity.this, MainScreenActivity.class);
